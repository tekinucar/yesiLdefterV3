...
namespace Tkn_DevView
{
    public class tDevView:tBase
    {
        ...
        public void tGridView_Create(DataRow row_Table, DataSet dsFields, DataSet dsData, 
            GridControl tGridControl, string TableIPCode)
        {
            ...
            tGridView.KeyDown += new System.Windows.Forms.KeyEventHandler(ev.myGridView_KeyDown);
            ...
            tGridView.FocusedColumnChanged += new DevExpress.XtraGrid.Views.Base.FocusedColumnChangedEventHandler(ev.myGridView_FocusedColumnChanged);
            tGridView.CellValueChanging += new DevExpress.XtraGrid.Views.Base.CellValueChangedEventHandler(ev.myGridView_CellValueChanging);
            tGridView.CellValueChanged += new DevExpress.XtraGrid.Views.Base.CellValueChangedEventHandler(ev.myGridView_CellValueChanged);
            tGridView.ColumnChanged += new System.EventHandler(ev.myGridView_ColumnChanged);
            ...
            tGridView.MouseMove += new System.Windows.Forms.MouseEventHandler(ev.myGridView_MouseMove);
            tGridView.MouseDown += new System.Windows.Forms.MouseEventHandler(ev.myGridView_MouseDown);
            tGridView.ColumnFilterChanged += new System.EventHandler(ev.myGridView_ColumnFilterChanged);
            tGridView.GotFocus += new System.EventHandler(ev.myGridView_GotFocus);
            // BUNU AÇINCA CHECKBOX BOZULUYOR
            //tGridView.LostFocus += new System.EventHandler(ev.myGridView_LostFocus);
            ...
            //if (t.IsNotNull(Prop_View))
            //    Preparing_View_(Prop_View, tGridView, null, null, null);
            if (t.IsNotNull(Old_PropView))
                Preparing_View_OLD(Old_PropView, tGridView, null, null, null);

            if (JSON_PropView != null)
                Preparing_View_JSON(JSON_PropView, tGridView, null, null, null, null);
        ...
        public void tTileView_Create(DataRow row_Table, DataSet dsFields, DataSet dsData, GridControl tGridControl)
        {
            ...
            tTileView.DoubleClick += new System.EventHandler(ev.myGridView_DoubleClick);
            tTileView.KeyDown += new System.Windows.Forms.KeyEventHandler(ev.myGridView_KeyDown);
            tTileView.KeyUp += new System.Windows.Forms.KeyEventHandler(ev.myGridView_KeyUp);
            tTileView.KeyPress += new System.Windows.Forms.KeyPressEventHandler(ev.myGridView_KeyPress);
            tTileView.FocusedColumnChanged += new DevExpress.XtraGrid.Views.Base.FocusedColumnChangedEventHandler(ev.myGridView_FocusedColumnChanged);
            ...
            tTileView.CellValueChanging += new DevExpress.XtraGrid.Views.Base.CellValueChangedEventHandler(ev.myGridView_CellValueChanging);

            tTileView.InvalidRowException += new DevExpress.XtraGrid.Views.Base.InvalidRowExceptionEventHandler(ev.myGridView_InvalidRowException);
            tTileView.ValidateRow += new DevExpress.XtraGrid.Views.Base.ValidateRowEventHandler(ev.myGridView_ValidateRow);
            tTileView.OptionsBehavior.ReadOnly = false;
            tTileView.OptionsBehavior.Editable = false;

            tTileView.MouseMove += new System.Windows.Forms.MouseEventHandler(ev.myTileView_MouseMove);
            tTileView.MouseDown += new System.Windows.Forms.MouseEventHandler(ev.myTileView_MouseDown);
            
            tTileView.ItemClick += new DevExpress.XtraGrid.Views.Tile.TileViewItemClickEventHandler(ev.myTileView_ItemClick);
            tTileView.ItemDoubleClick += new DevExpress.XtraGrid.Views.Tile.TileViewItemClickEventHandler(ev.myTileView_ItemDoubleClick);
            ...
            if (JSON_PropView != null)
                Preparing_View_JSON(JSON_PropView, null, null, null, tTileView, null);
        ...
        public void tAdvBandedGridView_Create(DataRow row_Table, DataSet dsFields, DataSet dsData, GridControl tGridControl)
        {
            tToolBox t = new tToolBox();
            tEvents ev = new tEvents();
            ...
            */
            ...
            //if (t.IsNotNull(Prop_View))
            //    Preparing_View_(Prop_View, null, tGridView, null, null);

            if (t.IsNotNull(Old_PropView))
                Preparing_View_OLD(Old_PropView, null, tGridView, null, null);

            if (JSON_PropView != null)
                Preparing_View_JSON(JSON_PropView, null, tGridView, null, null, null);
            ...
            DataSet dsFields, string TableIPCode)
        {
            ...
            if (gc > 0)
            {
                foreach (DataRow Row in dsFields.Tables[1].Rows)
                {
                    ...
                    {
                        CategoryRow row = new CategoryRow(caption);
                    ...
                    if (tButtonPanel != null)
                    {
                        ...
                        simpleButton_Gbutton.Click += new System.EventHandler(ev.checkGridGroupButton_Click);
...
*/
        ...
        */
        ...
        public void tCardView_Create(DataRow row_Table, DataSet dsFields, DataSet dsData, GridControl tGridControl, string TableIPCode)
        {
            ...
            tGridView.CustomDrawCardCaption += new DevExpress.XtraGrid.Views.Card.CardCaptionCustomDrawEventHandler(ev.myCardView_CustomDrawCardCaption);
            ...
            if (t.IsNotNull(Prop_View))
            {
                ...
                if (packet != null)
                    Preparing_View_JSON(packet, null, null, null, null, tGridView);
            }
            ...
            DevExpress.XtraVerticalGrid.VGridControl tVGridControl)
        {
            ...
            tVGridControl.DoubleClick += new System.EventHandler(ev.myGridView_DoubleClick);
            tVGridControl.GotFocus += new System.EventHandler(ev.myGridView_GotFocus);
            tVGridControl.KeyDown += new System.Windows.Forms.KeyEventHandler(ev.myGridView_KeyDown);
            tVGridControl.KeyUp += new System.Windows.Forms.KeyEventHandler(ev.myGridView_KeyUp);
            tVGridControl.KeyPress += new System.Windows.Forms.KeyPressEventHandler(ev.myGridView_KeyPress);
        ...
        public void tTreeListView_Create(DataRow row_Table, DataSet dsFields, DataSet dsData, 
            DevExpress.XtraTreeList.TreeList tTreeList)
        {
            tToolBox t = new tToolBox();
            tEvents ev = new tEvents();
            ...
            if (JSON_PropView != null)
                Preparing_View_JSON(JSON_PropView, null, null, tTreeList, null, null);
            
            // TreeListView in Column ları ekleniyor  
            tTreeList_Columns_Create(dsFields, tTreeList);
        ...
        #region tDataWizard Create Base
               ...
               byte ViewType, string FormName, vTableAbout vTA)
        {
            ...
            ///
            /// tPanelControl.ToString() == "DevExpress.XtraBars.Navigation.NavigationPane"
            ///
            ...
            if (tPanelControl.ToString() == "DevExpress.XtraBars.Navigation.NavigationPane")
            {
                ...
                for (int i = 1; i < navPageCount + 1; i++)
                {
                    ...
                    if (gvisible)
                    {
                        ...
                        /// 
                        Control newDataLayout = co.Create_View_(v.obj_vw_DataLayoutView, i, TableIPCode, "");
               ...
               DevExpress.XtraDataLayout.DataLayoutControl tDLayout, byte ViewType, string FormName)
        {
            ...
            tDataLayoutControl_Columns_Create(dsFields, dsData, tDLayout, ViewType, FormName, -1);
            ...
            )
        {
            ...
            if (Prop_Views.IndexOf(s1) > -1)
                DataLayout_TableLayoutMode_Preparing_OLD(Prop_Views,
                tDLayout,
                LCTabbedGroup,
                LCGroup);
            ...
            if (Prop_Views.IndexOf(s2) > -1)
                DataLayout_TableLayoutMode_Preparing_JSON(Prop_Views,
                tDLayout,
                LCTabbedGroup,
                LCGroup);
        ...
        private void DataLayout_TableLayoutMode_Preparing_JSON(string Prop_Views,
            DevExpress.XtraDataLayout.DataLayoutControl tDLayout,
            TabbedControlGroup LCTabbedGroup,
            LayoutControlGroup LCGroup
            )
        ...
        private void DataLayout_TableLayoutMode_Preparing_OLD(string Prop_Views,
            DevExpress.XtraDataLayout.DataLayoutControl tDLayout,
            TabbedControlGroup LCTabbedGroup,
            LayoutControlGroup LCGroup
            )
        {
            ...
            TLP_COLUMNS = t.Find_Properies_Get_FieldBlock(Prop_Views, "TLP_COLUMNS");
            TLP_ROWS = t.Find_Properies_Get_FieldBlock(Prop_Views, "TLP_ROWS");
            
            if ((tDLayout != null) && (t.IsNotNull(TLP_COLUMNS)))
            {
                tDLayout.Root.LayoutMode = LayoutMode.Table;
                tDLayout.Root.OptionsTableLayoutGroup.ColumnDefinitions.Clear();
                tDLayout.Root.OptionsTableLayoutGroup.RowDefinitions.Clear();
            ...
            if (LCTabbedGroup != null)
            {
                int colNo = t.myInt32(t.Set(t.MyProperties_Get(Prop_Views, "TLP_COLNO:"), "-1", "-1"));
                int rowNo = t.myInt32(t.Set(t.MyProperties_Get(Prop_Views, "TLP_ROWNO:"), "-1", "-1"));
                int colSpan = t.myInt32(t.Set(t.MyProperties_Get(Prop_Views, "TLP_COLSPAN:"), "-1", "-1"));
                int rowSpan = t.myInt32(t.Set(t.MyProperties_Get(Prop_Views, "TLP_ROWSPAN:"), "-1", "-1"));
                ...
                if ((move_item_type > 0) && (t.IsNotNull(move_item_name)))
                {
                    ...
                    if (tDLayout != null)
                    {
                        ...
                        if ((bl_item1 == null) && (group_no > 0) && (move_item_type > 0))
                        {
                            ...
                            if ((bl_groupitem != null) && (bl_groupitem.ToString() == "DevExpress.XtraLayout.LayoutControlGroup"))
                ...
                int groupno )
        {
            ...
            foreach (DataRow Row in dsFields.Tables[0].Rows)
            {
                ...
                if ((groupno == tgrp_no) && (tvisible))
                {
                    ...
                    dc.tXtraEditors_Edit(Row, dsData, null, item, tcolumntype, tdisplayformat, 1, ""); // "" = FormName
        ...
        private void Preparing_View_JSON(//string jsPacket,
                     PROP_VIEWS_IP prop_,
                     GridView tGridView,
                     AdvBandedGridView tAdvBGridView,
                     TreeList tTreeList,
        ...
        public void tGrid_Columns_Create(DataSet dsFields, DevExpress.XtraGrid.Views.WinExplorer.WinExplorerView tGridView, string TableIPCode)
        {
            ...
            //if (tGridView.ToString() == "DevExpress.XtraGrid.Views.WinExplorer.WinExplorerView")
            ...
            if (tvisible)
            {
                ...
                if (tsummary > 0) 
                {
                    if (tGridView != null)
                    {
                        ...
                        // field in displayformatı ile footer in displayformatı 
                        // birbirinden farklıymış  !!
                        ...
                        //}
                        //else
                        //    tSumdisplayformat = tdisplayformat;
                ...
                if (tvisible)
                {
                    ...
                    if (tsummary > 0)
                    {
                        if (tGridView != null)
                        {
                            ...
                            {
                                // bunlarda sorun var
                                //if (tsummary == 1) tdisplayformat = "Avr {0}";
                                //if (tsummary == 2) tdisplayformat = "Adet {0}";
                                //if (tsummary == 3) tdisplayformat = "{#,#}";
                                //if (tsummary == 4) tdisplayformat = "Min {#,#.#}";
                                //if (tsummary == 5) tdisplayformat = "Max {#,#.#}";
                                //if (tsummary == 6) tdisplayformat = "Top {#,#.00}";
                            ...
                            GridColumnSummaryItem item = new GridColumnSummaryItem(SummaryType, tfield_name, tSumdisplayformat);//tdisplayformat);
                            column.Summary.Add(item);
        ...
        public void tTreeList_Columns_Create(DataSet dsFields, TreeList tTreeList)
        {
            Boolean tvisible = false;
            string tcolumn_type = string.Empty;
            string tfield_name = string.Empty;
            ...
            foreach (DataRow Row in dsFields.Tables[0].Rows)
            {
                ...
                if (tvisible)
                {
                    ...
                    col.Tree_ColumnEdit(Row, column, tcolumn_type);
        ...
        public void tDataLayoutControl_Columns_Create(DataSet dsFields, DataSet dsData, 
            ...
            byte ViewType, string FormName, int groupNo)
        {
            tToolBox t = new tToolBox();
