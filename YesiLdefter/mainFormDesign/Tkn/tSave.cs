...
namespace Tkn_Save
{
    public class tSave:tBase
    {
        ...
        public bool tDataDontSave(Form tForm, string TableIPCode)
        {
            /// bu functiona şimdilik gerek kalmadı
            /// 
                ...
                if (pos > -1)
                {
                    ...
                    if (t.Find_TableFields(dsData, null))  // tablonun FieldListesi var ise   
                    {
                        ...
                        if (myProp.IndexOf("Prop_Runtime:True") > 0)
                        {
                            ...
                            ev.Prop_RunTimeClick(tForm, dsData, TableIPCode, v.nv_102_AUTO_INS);
                        }
            ...
            if ((dsData != null) && (pos > -1))
            {
                ...
                if (dsData.Tables[0].CaseSensitive == false)
                {
                    ...
                    v.Kullaniciya_Mesaj_Var =
                            MyRecord(dsData, vt, pos, (byte)v.Save.KAYDET);
                }
                ...
                {
                    tEvents ev = new tEvents();
                    ev.Prop_RunTimeClick(tForm, null, vt.TableIPCode, v.nv_24_Kaydet);
                }
        ...
        public string Insert_Scrip_Multi(DataSet ds_Target, string Target_TableName, SqlConnection VTbaglanti)
        {
        ...
        public string Insert_Scrip_Master_Detail(
                               ...
                               byte Sonuc)
        {
            ...
            else
            {
                ...
                v.con_Refresh =
                Record_SQL_RUN(ds, vt, State, Position, ref Sonuc_Cumle, TriggerSQL);
            ...
            ref string TriggerSQL)
        {
            ...
            for (int i = 0; i < c; i++)
            {
                ...
                //ValidationInsert = t.Set(ds.Tables[TableFields2].Rows[i]["VALIDATION_INSERT"].ToString(), "", "False");
                //fForeing = t.Set(ds.Tables[TableFields2].Rows[i]["FFOREING"].ToString(), "", "False");
                //fTrigger = t.Set(ds.Tables[TableFields2].Rows[i]["FTRIGGER"].ToString(), "", "False");

                t.OtherValues_Get(ds, tableFieldsName + "2", fname, ref ValidationInsert, ref fForeing, ref fTrigger, ref displayFormat);
                    ...
                    )
                {
                    ...
                    //* text = (char)175, (varchar)167, (ntext)99, (text)35, (nchar)239, (nvarchar)231, (uniqueidentifier)39 
                    if ((ftype == 175) | (ftype == 167) | (ftype == 99) | (ftype == 35) | (ftype == 239) | (ftype == 231) | (ftype == 39))
                    {
                        MyField = MyField + bos + fname + ", ";
                    ...
                    (Lkp_fname != "LKP_") & (Lkp_fname != "rowg"))
                {
                    ...
                    */
                    ...
                    if ((ftype == 175) | (ftype == 167) | (ftype == 99) | (ftype == 35) | (ftype == 239) | (ftype == 231) | (ftype == 39))
                    {
                        // alınan değeri stringe ekle
                        if ((fvalue != "") && (fvalue != "null"))
                            MyStr = MyStr + " [" + fname + "] = " + "'" + t.Str_Check(fvalue) + "', ";
                        else MyStr = MyStr + " [" + fname + "] = " + "null, ";// Eğer veri yok ise null bas
                    }
                    ...
                    {
                        if ((fvalue != "") && (fvalue.IndexOf("01.01.0001") == -1) && fvalue != "null") 
                            MyStr = MyStr + " [" + fname + "] = " + t.Tarih_Formati(Convert.ToDateTime(fvalue)) + ", ";
                    ...
                    {
                        if ((fvalue != "") && (fvalue.IndexOf("01.01.0001") == -1) && fvalue != "null")
                            MyStr = MyStr + " [" + fname + "] = " + t.TarihSaat_Formati(Convert.ToDateTime(fvalue)) + ", ";
                        else MyStr = MyStr + " [" + fname + "] = " + "null, ";
                    }
            ...
            if (State == "dsInsert")
            {
                ...
                if (MyIfW != "")
                {
                    ...
                    */
                    ...
                    // sorunu bulamadım
                    MyStr =
                        " if ( Select count(*) ADET from [" + Table_Name + "] where 0 = 0 " + v.ENTER
                      + MyIfW + " ) = 0 " + v.ENTER
                      + " begin " + v.ENTER
                      + " insert into [" + Table_Name + "] ( " + v.ENTER 
                      +   MyField + " ) values " + v.ENTER 
                      + " ( " + MyValue + " ) " + line_end
                      + " --IdentityID " + v.ENTER
                      //+ " --Trigger " + v.ENTER
                      + " end else " + v.ENTER
                      + "   Select 0 as ID " + v.ENTER;
                      //+ "   --Trigger " + v.ENTER;

                    
                    /*
                    MyStr = " insert into [" + Table_Name + "] ( " + v.ENTER +
                     MyField + " ) values " + v.ENTER +
                     " ( " + MyValue + " ) " + v.ENTER +
                     " --IdentityID " + v.ENTER;
                    */
            ...
            if (State == "dsEdit")
            {
                ...
                MyStr = MyStr + v.ENTER2 + "  " + MyStr2 + v.ENTER2;
                //+ "  --Trigger " + v.ENTER;
            }
