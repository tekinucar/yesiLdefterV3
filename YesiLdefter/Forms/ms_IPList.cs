...
{
    public partial class ms_IPList : Form //DevExpress.XtraEditors.XtraForm
    {
        ...
        private void ms_IPList_Shown(object sender, EventArgs e)
        {
            ...
            //
            editpanel_TestSQL = t.Find_Control(this, v.lyt_Name + "04_04_01");
        ...
        private void Test()
        {
            ...
            t.SelectPage(this, v.lyt_Name + "04", "", 2);
            // ---

            Control page = t.Find_Control(this, v.lyt_Name + "04_03");// "39");
            ...
            if (page != null)
            {
                ...
                if (ds_MSTablesIP != null)
                {
                    if (dN_MSTablesIP.Position > -1)
                    {
                        ...
                        //
                        TableIPCode = ds_MSTablesIP.Tables[0].Rows[dN_MSTablesIP.Position]["TABLE_CODE"].ToString() + "." +
        ...
        private void CopyMsfIPMsfIP()
        {
            ...
            if (t.UserInpuBox(iBox) == DialogResult.OK)
            {
                ...
                {
                    string Sql = MSFieldsIP_Insert_Sql(TableCode, OldIPCode, newIPCode);
        ...
        private void CopyMsTIPMsTIP()
        {
            ...
            if (t.UserInpuBox(iBox) == DialogResult.OK)
            {
                ...
                if (t.IsNotNull(NewIPCode))
                {
                    ...
                    string Sql = MSTablesIP_Insert_Sql(TableCode, OldIPCode, NewIPCode);
