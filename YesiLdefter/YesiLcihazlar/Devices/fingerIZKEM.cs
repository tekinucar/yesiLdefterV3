...
{
    public class fingerK50_SDKHelper : IZKEM
    {
        Action<object, string> RaiseDeviceEvent;

        public fingerK50_SDKHelper(Action<object, string> RaiseDeviceEvent)
        { 
        ...
        public bool DeleteEnrollData(int dwMachineNumber, int dwEnrollNumber, int dwEMachineNumber, int dwBackupNumber)
        {
            ...
            if (objCZKEM.SSR_DeleteEnrollData(dwMachineNumber, dwEnrollNumber.ToString(), dwBackupNumber))
            {
        ...
        {
            return objCZKEM.GetUserTmpStr(dwMachineNumber, dwEnrollNumber, dwFingerIndex, ref TmpData, ref TmpLength);
            // throw new NotImplementedException();
        }
        ...
        public bool SetDeviceTime2(int iMachineNumber, int idwYear, int idwMonth, int idwDay, int idwHour, int idwMinute, int idwSecond)
        {
            bool sonuc = false;

            if (objCZKEM.SetDeviceTime2(iMachineNumber, idwYear, idwMonth, idwDay, idwHour, idwMinute, idwSecond))
            {
                objCZKEM.RefreshData(iMachineNumber);//the data in the device should be refreshed
                sonuc = true;
            }
            else
            {
        ...
        public bool SSR_DeleteEnrollData(int dwMachineNumber, string dwEnrollNumber, int dwBackupNumber)
        {
            ...
            if (objCZKEM.SSR_DeleteEnrollData(dwMachineNumber, dwEnrollNumber, dwBackupNumber))
            {
                objCZKEM.RefreshData(dwMachineNumber);//the data in the device should be refreshed
            ...
            else
            {
                ...
                if (idwErrorCode == 0 && dwBackupNumber == 11)
                    hata = "SSR_DeleteEnrollData,UserID=" + dwEnrollNumber + " BackupNumber=" + dwBackupNumber.ToString();
                else
                    hata = "*Operation failed,ErrorCode=" + idwErrorCode.ToString();
            }

            return idwErrorCode == 0;
        }
        ...
        public bool SSR_SetUserTmpStr(int dwMachineNumber, string dwEnrollNumber, string name, int dwFingerIndex, string TmpData)
        {
            int idwErrorCode = 0;

            if (objCZKEM.SSR_SetUserInfo(dwMachineNumber, dwEnrollNumber, name, "", 0, true))//upload user information to the device
            {

                objCZKEM.SetUserTmpExStr(dwMachineNumber, dwEnrollNumber, 0, 1, TmpData);//upload templates information to the device
        ...
        public bool GetBZ400FirmwareVersion(int dwMachineNumber, ref string strVersion)
        {
            throw new NotImplementedException();
        }

        public bool UnlockREP(int dwMachineNumber)
        {
            throw new NotImplementedException();
        }

        public bool RefreshOptions(int dwMachineNumber)
        {
            throw new NotImplementedException();
        }

        public bool GetMRPTotal(int dwMachineNumber, int MRPType, ref int Value)
        {
            throw new NotImplementedException();
        }

        public bool GetUnlockPwd(string LockSerialNumber, ref string UnlockPwd)
        {
            throw new NotImplementedException();
        }

        public bool SetSeekPosition(int dwMachineNumber, int Position)
        {
            throw new NotImplementedException();
        }

        public bool GetDatetimeOpLog(int dwMachineNumber, out string nsr, out string OldDatetime, out string NewDatetime)
        {
            throw new NotImplementedException();
        }
        ...
        public bool SSR_SetUserInfoEx(int dwMachineNumber, string dwEnrollNumber, string Name, string Password, int Privilege, bool Enabled, string pis, string CPF)
        {
            throw new NotImplementedException();
        }

        public bool GetUserTmpEx_BZ400(int dwMachineNumber, string dwEnrollNumber, int dwFingerIndex, out int Flag, out byte TmpData, out int TmpLength)
        {
            throw new NotImplementedException();
        }

        public bool GetUserTmpExStr_BZ400(int dwMachineNumber, string dwEnrollNumber, int dwFingerIndex, out int Flag, out string TmpData, out int TmpLength)
        {
            throw new NotImplementedException();
        }

        public bool SetUserTmpEx_BZ400(int dwMachineNumber, string dwEnrollNumber, int dwFingerIndex, int Flag, ref byte TmpData)
        {
            throw new NotImplementedException();
        }

        public bool SetUserTmpExStr_BZ400(int dwMachineNumber, string dwEnrollNumber, int dwFingerIndex, int Flag, string TmpData)
        {
            throw new NotImplementedException();
        }

        public bool SSR_DeleteEnrollDataExt_BZ400(int dwMachineNumber, string dwEnrollNumber, int dwBackupNumber)
        {
            throw new NotImplementedException();
        }

        public bool GetRealFirmwareVersion(int dwMachineNumber, ref string strVersion)
        {
            throw new NotImplementedException();
        }

        public bool UpdateZKOS(int dwMachineNumber, string FileName)
        {
            throw new NotImplementedException();
        }

        public bool GetDatetimeOpLog_BZ900(int dwMachineNumber, out string nsr, out string OldDatetime, out string NewDatetime, out string OpTCPF)
        {
            throw new NotImplementedException();
        }
