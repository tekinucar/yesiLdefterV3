...
namespace Tkn_Layout
{
    class tLayout : tBase
    {
        ...
        {
            Cursor.Current = Cursors.Hand;   //AppStarting;
            ...
            foreach (DataRow row in ds_Layout.Tables[0].Rows)
            {
                ...
                if (visible == "True")
                {
                    if (LayoutType == v.lyt_menu) lMenu_Preparing(tForm, ds_Layout, row, pos);
                    if ((LayoutType == v.lyt_dockPanel) && (dockPanel == false))
                    {
                        lDockPanel_Preparing(tForm, ds_Layout, row);
                        dockPanel = true;
                    }
                    if (LayoutType == v.lyt_tableLayoutPanel) ltableLayoutPanel_Preparing(tForm, ds_Layout, row, pos);
                    if (LayoutType == v.lyt_splitContainer) lSplitContainer_Preparing(tForm, ds_Layout, row, pos);
                    if (LayoutType == v.lyt_groupControl) lGroupControl_Preparing(tForm, ds_Layout, row, pos);
                    if (LayoutType == v.lyt_panelControl) lPanelControl_Preparing(tForm, ds_Layout, row, pos);

                    if (LayoutType == v.lyt_tabPane) lTabPane_Preparing(tForm, ds_Layout, row, pos);
                    if (LayoutType == v.lyt_tabNavigationPage) lTabNavigationPage_Preparing(tForm, ds_Layout, row, pos);

                    if (LayoutType == v.lyt_navigationPane) lNavigationPane_Preparing(tForm, ds_Layout, row, pos);
                    if (LayoutType == v.lyt_navigationPage) lNavigationPage_Preparing(tForm, ds_Layout, row, pos);

                    if (LayoutType == v.lyt_tabControl) lTabControl_Preparing(tForm, ds_Layout, row, pos);
                    if (LayoutType == v.lyt_tabPage) lTabPage_Preparing(tForm, ds_Layout, row, pos);

                    if (LayoutType == v.lyt_backstageViewControl) lBackstageViewControl_Preparing(tForm, ds_Layout, row, pos);
                    ...
                    if (LayoutType == v.lyt_headerPanel) lHeaderPanel_Preparing(tForm, ds_Layout, row, pos);
                    if (LayoutType == v.lyt_editPanel) lEditPanel_Preparing(tForm, ds_Layout, row, pos);
                    if (LayoutType == v.lyt_labelControl) lLabelControl_Preparing(tForm, ds_Layout, row, pos);
                    if (LayoutType == v.lyt_BarcodeControl1) lBarcodControl1_Preparing(tForm, ds_Layout, row, pos);

                    if (LayoutType == v.lyt_documentManager) lDocumentManager_Preparing(tForm, ds_Layout, row, pos);
        ...
        private void ltableLayoutPanel_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
            ...
            else tableLayoutPanel1.Size = new System.Drawing.Size(tForm.Width, tForm.Height);
        ...
        private void lSplitContainer_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
        ...
        #region groupControl
        private void lGroupControl_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
        ...
        #region panelControl
        private void lPanelControl_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
        ...
        private void lTabPane_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
        ...
        private void lTabNavigationPage_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            ...
            //tabNavigationPage1.Padding = new System.Windows.Forms.Padding(v.Padding4);                                                                                      //tabNavigationPage1.Padding = new System.Windows.Forms.Padding(v.Padding4);
        ...
        private void lNavigationPane_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
        ...
        private void lTabControl_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
        ...
        private void lBackstageViewControl_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
        ...
        private void lDocumentManager_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
        ...
        private void lHeaderPanel_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
        ...
        private void lEditPanel_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
            ...
            if (UstHesapRow != null)
            {
                ...
                if (dsData != null)
                    dc.tXtraEditors_Edit(null, dsData, null, panelControl1, tcolumntype, tdisplayformat, 1, ""); // "" = FormName
                else dc.tXtraEditors_Edit(null, null, null, panelControl1, tcolumntype, tdisplayformat, 1, ""); // "" = FormName
        ...
        private void lLabelControl_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
        ...
        public void lBarcodControl1_Preparing(Form tForm, DataSet ds_Layout, DataRow row, int pos)
        {
            tToolBox t = new tToolBox();
            tEvents ev = new tEvents();
            ...
            string ustControlName, string ustControlType, DataRow row)
        {
            ...
            if (c != null)
            {
                ...
                #region GroupControl
                if (c.ToString() == "DevExpress.XtraEditors.GroupControl")
                {
                ...
                #region PanelControl
                if (c.ToString() == "DevExpress.XtraEditors.PanelControl")
                {
                ...
                (c != null))
            {
                ...
                Control cntrl = null;
                if (c.ToString() == "DevExpress.XtraBars.Ribbon.BackstageViewClientControl")
                {
                ...
                if (cntrl != null)
                {
                    ...
                    {
                        if (item2.ToString() == "DevExpress.XtraBars.Ribbon.BackstageViewClientControl")
                        {
                ...
                //{
                //    if (item1.ToString() == "DevExpress.XtraBars.Ribbon.BackstageViewControl")
                //    {
                ...
                //{
                //    if (a.ToString() == "DevExpress.XtraBars.Ribbon.BackstageViewClientControl")
                //    {
