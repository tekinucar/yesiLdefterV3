...
namespace Tkn_InputPanel
{
    public class tInputPanel:tBase
    {
            ...
            byte IP_View_Type)
        {
            ...
            if (tPanelControl.ToString() == "DevExpress.XtraEditors.XtraUserControl")
                     ...
                     DataSet ds_Table, DataSet ds_Fields)
        {
            ...
            else
            {
                ...
                if (ds_Data != null)
                {
                    ...
                    /// bu işaretleme  ( t.External_Controls_Enabled ) 
                    /// içinde kontrola yarıyor
                    /// 
                }
                else
                {
            ...
            if (cntrl == null)
            {
                ...
                cntrl = co.Create_View(row_Table, TableIPCode, MultiPageID);
            ...
            if (cntrl != null)
            {
                ...
                {
                    dv.tGridView_Create(row_Table, ds_Fields, ds_Data, (DevExpress.XtraGrid.GridControl)cntrl, TableIPCode);
                ...
                {
                    dv.tAdvBandedGridView_Create(row_Table, ds_Fields, ds_Data, (DevExpress.XtraGrid.GridControl)cntrl);
                    co.Create_AdvBandedGrid_Group_Buttons(tForm, tPanelControl, row_Table, ds_Fields);
                    co.Create_SpeedKriter(tForm, tPanelControl, row_Table, ds_Fields, MultiPageID);
                    co.Create_GridFindPanel(tForm, tPanelControl, (DevExpress.XtraGrid.GridControl)cntrl);
                }
                ...
                {
                    dv.tTreeListView_Create(row_Table, ds_Fields, ds_Data, (DevExpress.XtraTreeList.TreeList)cntrl);
                ...
                cntrl.DragEnter += new System.Windows.Forms.DragEventHandler(ev.myGridView_DragEnter);
                     ...
                     DataSet ds_Table, DataSet ds_Fields)
        {
            ...
            {
                cntrl = co.Create_View_(v.obj_vw_VGridSingle, RefID, TableIPCode, MultiPageID);
